  ...
  PVOID Options)
{
  ...
  case IPPROTO_TCP:
      if (Address->Address[0].Address[0].sin_port)
      {
          ...
          AddrFile->Port = (USHORT)TCPAllocatePort(Address->Address[0].Address[0].sin_port);
      ...
      else if (!AddrIsUnspecified(&AddrFile->Address))
      {
          ...
          AddrFile->Port = (USHORT)TCPAllocatePort(0);
  ...
  case IPPROTO_UDP:
      ...
      AddrFile->Port =
      (USHORT)UDPAllocatePort(Address->Address[0].Address[0].sin_port);
